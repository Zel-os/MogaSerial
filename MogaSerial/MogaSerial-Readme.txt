...
here.  Also thanks for the license section which I'm shamelessly copying from
that tool's readme file.  Thanks as well to the ZeeMouse author for showing
...
LICENSE:
For the purposes of this license, "this software" refers to MogaSerial.exe.
vJoyInterface.dll is released under the license of its creators.
This software may be used and shared freely, so long as the following conditions are met:
1) This software may not be bundled with any other software, and the executable
 and included files may not be distributed in a modified state.
2) If you distribute this software, you must give attribution to its creator.
 You may not imply that you have created this software.
3) You must obey the license restrictions of the libraries this application depends on:
 vJoy (vjoystick.sourceforge.net)
